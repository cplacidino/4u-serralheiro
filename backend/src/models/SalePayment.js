...
const salePaymentSchema = new mongoose.Schema({
  ...
  budget:     { type: mongoose.Schema.Types.ObjectId, ref: 'Budget' },   // opcional para avulsos
  client:     { type: mongoose.Schema.Types.ObjectId, ref: 'Client' },   // opcional para avulsos
  clientName: { type: String },                                           // nome livre quando não há cliente cadastrado
  source:     { type: String, enum: ['budget', 'avulso'], default: 'budget' },
