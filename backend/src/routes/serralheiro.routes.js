...
const { getPaymentsByBudget, addPayment, addAvulsoPayment, receiveFiado, deletePayment, getFiados, getCheques, compensarCheque, devolverCheque, getNotificationCount } = require('../controllers/payment.controller');
...
router.post('/payments/avulso', addAvulsoPayment);
